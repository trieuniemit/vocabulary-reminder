    ...
    <div class="col-md-7">
        <form action="" class="form-inline" autocomplete="off">
            <div class="form-group" style="margin: 0 5px;">
                <input type="text" name="q" id="search" value="{{request()->q}}" class="form-control" placeholder="Nhập từ cần tra..." autocomplete="off">
            </div>
    ...
    @foreach ($vocas as $index => $voca)
        ...
        <div class="word_elm">
            <h5 style="text-transform: capitalize;margin: 0;" class="show_tooltip" data-toggle="tooltip" data-placement="bottom" data-html="true" 
                ...
                ">
                <a href="{{route('user_vocabulary_detail', ['word' => $voca->word])}}" style="color: #000;">{{$voca->word}}</a>
            </h5>
        </div>
    @endforeach
    <!-- end item -->
...
<div class="w-full bg-white py-1 px-2 clearfix d-flex justify-content-end" style="border-top: 1px solid rgba(0,0,0,0.12);margin-top: 20px;padding-top: 20px !important">
